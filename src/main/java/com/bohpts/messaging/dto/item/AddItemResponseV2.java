...
public class AddItemResponseV2 extends ResponseV2<ItemRequestStatus> {
    ...
    public AddItemResponseV2(UUID correlationId, ItemRequestStatus status) {
        this(correlationId, status, null);
    }

    public AddItemResponseV2(UUID correlationId, ItemRequestStatus status, String message) {
        super();
